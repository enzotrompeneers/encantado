...
class Formulario
{
    ...
    protected $errores = [];
    protected $db;
    protected $archivos_permitidos = ['png', 'jpg', 'jpeg', 'doc', 'docx', 'pdf'];

    protected $ignores = ['submit', 'condiciones', 'id', 'code', 'g-recaptcha-response'];
    ...
    public function save($ignores = [])
    {
        ...
        $insert['apellido'] = (!empty($cleanStrings['apellido'])) ? $cleanStrings['apellido'] : '';
        $insert['email'] = $cleanStrings['email'];
        $insert['telefono'] = $cleanStrings['telefono'];
        $insert['empresa'] = (!empty($cleanStrings['empresa'])) ? $cleanStrings['empresa'] : '';
        $insert['localidad'] = $cleanStrings['localidad'];
        $insert['categoria'] = (!empty($cleanStrings['categoria'])) ? $cleanStrings['categoria'] : '';
        $insert['mensaje'] = (!empty($cleanStrings['mensaje'])) ? $cleanStrings['mensaje'] : '';
        $insert['email_completo'] = $fullEmail;
        $insert['encontrado'] = (!empty($cleanStrings['encontrado'])) ? $cleanStrings['encontrado'] : '';
