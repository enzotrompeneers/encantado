<div class="inicio-form">
    ...
    <form action="<?=$language?>/<?=slugged('inicio')?>/send/#inicio-form"
        class="multi-form" id='inicioform' method="post" name="inicio-form" data-abide="ajax" novalidate>
        <fieldset class="active">
            <div class="grid-x grid-margin-x">
                ...
                <div class="small-12 medium-6 cell">
                    <label for="email">
                        <?= trad('e_mail') ?>*</label>
                    <input id="email" name="email" required pattern="email" type="text">
                </div>
                <div class="small-12 medium-6 cell">
                    <label for="telefono">
                        <?= trad('telefono') ?>*</label>
        ...
        <div class="buttons">
            ...
            <a id="btn-next" class="next">
                <div class="circle">
                    <img alt="Next" src="graphics/noun_1086550.svg">
                </div>
            </a>
            <button class="submit circle">
