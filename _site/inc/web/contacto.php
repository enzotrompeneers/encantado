	...
	<div class="row collapse">
		...
		<div class="medium-4 columns ">
			<h2><?=webConfig('nombre');?></h2><br />
			<p><?=trad('telefono');?>: <?=webConfig('telefono');?><br /><?=trad('movil');?>: <?=webConfig('movil');?></p>
			<p><?=trad('email');?>: <a href="mailto:<?=webConfig('email');?>"><?=webConfig('email');?></a></p>
			<h4><?=trad('direccion');?></h4>
			<p><?=webConfig('calle');?><br /><?=webConfig('codigo_postal');?> <?=webConfig('ciudad');?> <br /><?=webConfig('provincia');?></p>
		</div>	
